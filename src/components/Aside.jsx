...
export default function Aside() {
  ...
  return (
    <aside className="h-screen w-[85vw] max-w-80 overflow-y-auto border-l border-white/10 bg-neutral-900/70 p-4 text-white backdrop-blur-xl sm:w-80 sm:p-6 hide-scrollbar">
